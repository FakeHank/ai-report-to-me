...
- Если за день нет достойных срезов, напишите «Сегодняшняя работа была рутинной разработкой, без заметных срезов опыта.» — не вымучивайте`,
  ...
  'install.nextStepsDayreport': {
    en: '/dayreport    — generate a daily report (Codex: $dayreport)',
    zh: '/dayreport    — 生成日报（Codex 中用 $dayreport）',
    ja: '/dayreport    — 日報を生成（Codexでは $dayreport）',
    ko: '/dayreport    — 일일 보고서 생성 (Codex: $dayreport)',
    ru: '/dayreport    — сгенерировать дневной отчёт (Codex: $dayreport)',
  },
  'install.nextStepsQtreport': {
    en: '/qtreport     — generate a 90-day Wrapped summary (Codex: $qtreport)',
    zh: '/qtreport     — 生成 90 天 Wrapped 总结（Codex 中用 $qtreport）',
    ja: '/qtreport     — 90日間のWrappedサマリーを生成（Codexでは $qtreport）',
    ko: '/qtreport     — 90일 Wrapped 요약 생성 (Codex: $qtreport)',
    ru: '/qtreport     — сгенерировать 90-дневный отчёт Wrapped (Codex: $qtreport)',
  },
